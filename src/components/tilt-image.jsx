...
export default function TiltedImage({ rotateAmplitude = 3, }) {
    ...
    return (
        ...
        >
            <motion.div className="relative [transform-style:preserve-3d] w-full max-w-6xl scale-120" style={{ rotateX, rotateY }} >
                <img src="/assets/model-library.png"
                    className="w-full rounded-[15px] will-change-transform [transform:translateZ(0)]"
                    alt="AI Dev Kit Model Library"
                />
            </motion.div>
        </motion.figure>
    );
